    ...
    <div className="min-h-full max-w-3xl">
      ...
      <section className="bg-white rounded-2xl p-6 sm:p-8 atmospheric-shadow border border-outline-variant/10 mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
          <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary font-black text-xl font-headline">DS</div>
          <div className="flex-1">
            <h3 className="text-lg font-bold font-headline">Dr. Sterling</h3>
            <p className="text-sm text-on-surface-variant">sterling@university.edu • Faculty Head</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <input className="w-full px-4 py-3 bg-surface-container-high/50 rounded-lg text-sm text-on-surface border-none focus:ring-2 focus:ring-primary/30" defaultValue="Dr. Sterling" />
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest text-outline">Department</label>
            <input className="w-full px-4 py-3 bg-surface-container-high/50 rounded-lg text-sm text-on-surface border-none focus:ring-2 focus:ring-primary/30" defaultValue="Computer Science" />
          </div>
        </div>
      </section>
